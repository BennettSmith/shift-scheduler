...
public protocol AuthRepository: Sendable {
    ...
    func signInWithApple(identityToken: Data, nonce: String) async throws -> UserId
    ...
    /// - Returns: The authenticated user's ID.
    func signInWithGoogle(idToken: String, accessToken: String) async throws -> UserId
    ...
    func observeAuthState() -> AsyncStream<UserId?>
}
